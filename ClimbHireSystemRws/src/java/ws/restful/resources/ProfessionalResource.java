...
public class ProfessionalResource {
    ...
    public Response retrieveProduct(@QueryParam("email") String email, 
                                        ...
                                        @PathParam("professionalId") Long professionalId)
    {
        try
        {
            ...
            ProfessionalEntity professionalEntity = professionalEntitySessionBeanLocal.retrieveProfessionalById(professionalId);
                   
            return Response.status(Status.OK).entity(new RetrieveProfessionalRsp(professionalEntity)).build();
        }
        /*
