...
@Stateless
@Local(TagEntitySessionBeanLocal.class)
public class TagEntitySessionBean implements TagEntitySessionBeanLocal
{
    ...
    public void deleteTag(Long tagId) throws TagNotFoundException, DeleteTagException
    {
        ...
        if(!tagEntityToRemove.getJobEntities().isEmpty())
        {
            throw new DeleteTagException("Tag ID " + tagId + " is associated with existing jobs and cannot be deleted!");
        }
        else
        {
